...
* working with time stamps, smoothing time series data using pandas.rolling()
* Data Visualization with Matplotlib
* Do you wanna know which programming language is the most popular on Stack Over flow? 📈


## 📁 Project Structure
* `Programming_Languages.ipynb` - The main Analysis using Jupyter lab.
* `QueryResults_StackOverflow.csv` - Kaggle data file.
